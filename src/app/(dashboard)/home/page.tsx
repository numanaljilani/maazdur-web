  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 px-2">
        ...
        <div className="flex items-center gap-3 mt-2 sm:mt-0  w-full">
          ...
          {[
            {
              ...
              icon: <FaBoxes className="text-cyan-500" size={25} />,
              service: "Helper",
            },
            {
              name: language ? "नौकरानी" : "Maid",
              icon: <FaFemale className="text-green-500" size={25} />,
              service: "Maid",
            },
            {
              name: language ? "किसान" : "Farming",
              icon: (
                <Image
                  src="/farmer.png"
                  style={{ color: "green" }}
            ...
            {
              name: language ? "मरम्मत" : "Repairing",
              icon: <FaHammer className="text-orange-500" size={25} />,
              service: "Repairing",
            },
            {
            ...
            },
            {
              ...
              icon: <LuWashingMachine className="text-yellow-500" size={25} />,
              service: "Laundry",
            },
            {
              name: language ? "उपकरण" : "Appliances",
              icon: <MdMicrowave className="text-red-500" size={25} />,
              service: "Appliances",
            },
            {
              name: language ? "स्थानांतरण" : "Shifting",
              icon: <FaTruck className="text-cyan-500" size={25} />,
              service: "Shifting",
            },
            {
              name: language ? "नलकारी" : "Plumbing",
            ...
            <Link
              ...
              href={
                item.service === "More"
                  ? "/more-services"
                  : `/subcategories?service=${item.service}`
              }
              className="flex flex-col items-center"
            >
              <div
                className={`w-11 h-11 rounded-full flex justify-center items-center bg-opacity-10 ${
                  item.service === "Helper"
                    ? "bg-cyan-200"
                    : item.service === "Maid"
                    ? "bg-green-200"
                    : item.service === "Farming"
                    ? "bg-purple-200"
                    : item.service === "Repairing"
                    ? "bg-orange-200"
                    : item.service === "Painting"
                    ? "bg-blue-200"
                    : item.service === "Laundry"
                    ? "bg-yellow-200"
                    : item.service === "Appliances"
                    ? "bg-red-200"
                    : item.service === "Shifting"
                    ? "bg-cyan-200"
                    : item.service === "Plumbing"
                    ? "bg-green-200"
                    : "bg-purple-200"
                }`}
              >
